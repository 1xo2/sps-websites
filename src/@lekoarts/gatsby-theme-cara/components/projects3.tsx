  ...
  <div>
    ...
    <Divider speed={0.1} offset={offset} factor={factor}>
      <UpDown>
        ...
        <SVG icon="meLogo" width={6} color="icon_brightest" left="85%" top="95%" />
      ...
      <UpDownWide>
        <SVG icon="meLogo"  width={26} color="icon_green" left="20%" top="95%" />
      ...
      <SVG icon="meLogo" width={6} color="icon_brightest" left="4%" top="10%" />
